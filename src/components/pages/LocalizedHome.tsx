        ...
        <section className="project-preview container">
          {author &&
            itemsFor(author).map((item) => (
              <article key={item.id} className="author-pane cms-editable-card">
                <InlineItemEditor locale={locale} item={item} portraitOnly />
                {item.image_url && (
                  <div className="portrait">
                    <img
                      src={item.image_url}
                      alt={local(item, "title", locale)}
                      style={{
                        width: "100%",
                        height: "100%",
                        display: "block",
          ...
          {project &&
            itemsFor(project).map((item) => (
              <article key={item.id} className="project-pane cms-editable-card">
                <InlineItemEditor locale={locale} item={item} />
