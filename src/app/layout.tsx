...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) { return <html dir="rtl"><body className={`${heebo.variable} ${arabic.variable}`}>{children}</body></html>; }
